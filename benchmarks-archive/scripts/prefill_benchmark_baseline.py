#!/usr/bin/env python3
"""
Python TurboMind Prefill 性能基准测试 - Qwen3.6-35B-A3B-AWQ
建立正确的性能基线
"""
...
sys.path.insert(0, str(Path(__file__).parent.parent / "lmdeploy"))
...
async def run_benchmark():
    print("=" * 80)
    print("Python TurboMind Prefill 性能基准测试 - Qwen3.6-35B-A3B-AWQ")
    print("=" * 80)
    print(f"\nModel: {MODEL}")
    ...
    print(f"\n{'Context':>8} | {'Tokens':>8} | {'Avg TTFT':>10} | "
    ...
    out_path = Path(__file__).parent / "prefill_benchmark_baseline.json"
