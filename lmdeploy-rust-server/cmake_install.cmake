...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib" TYPE MODULE FILES "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/lib/_turbomind.cpython-312-x86_64-linux-gnu.so")
  if(EXISTS "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_turbomind.cpython-312-x86_64-linux-gnu.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_turbomind.cpython-312-x86_64-linux-gnu.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_turbomind.cpython-312-x86_64-linux-gnu.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/src/turbomind/python/CMakeFiles/_turbomind.dir/install-cxx-module-bmi-Release.cmake" OPTIONAL)
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib" TYPE MODULE FILES "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/lib/_xgrammar.cpython-312-x86_64-linux-gnu.so")
  if(EXISTS "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_xgrammar.cpython-312-x86_64-linux-gnu.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_xgrammar.cpython-312-x86_64-linux-gnu.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/_xgrammar.cpython-312-x86_64-linux-gnu.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/src/turbomind/python/CMakeFiles/_xgrammar.dir/install-cxx-module-bmi-Release.cmake" OPTIONAL)
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib" TYPE SHARED_LIBRARY FILES "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/lib/libturbomind_c.so")
  if(EXISTS "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/libturbomind_c.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/libturbomind_c.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy/lib/libturbomind_c.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/src/turbomind/capi/CMakeFiles/turbomind_c.dir/install-cxx-module-bmi-Release.cmake" OPTIONAL)
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/_deps/yaml-cpp-build/cmake_install.cmake")
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/_deps/xgrammar-build/cmake_install.cmake")
  include("/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/src/cmake_install.cmake")
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/mnt/eaget-4tb/data/llm_server/lmdeploy/lmdeploy-rust-server/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
