...
// Initialize TurboMind from HuggingFace model directory (safetensors format).
// Reads config.json for architecture, loads weights from model*.safetensors shards,
// builds the model graph, and prepares the engine for inference.
