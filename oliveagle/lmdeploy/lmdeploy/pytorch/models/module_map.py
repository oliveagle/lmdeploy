...
# qwen3.5 (text-only, uses qwen3_5.Qwen3_5ForCausalLM)
MODULE_MAP.update({
    'Qwen3_5ForCausalLM': f'{LMDEPLOY_PYTORCH_MODEL_PATH}.qwen3_5.Qwen3_5ForCausalLM',
    'Qwen3_5ForConditionalGeneration': f'{LMDEPLOY_PYTORCH_MODEL_PATH}.qwen3_5.Qwen3_5ForCausalLM',
})

# qwen3.5 moe
MODULE_MAP.update({
    'Qwen3_5MoeForConditionalGeneration': f'{LMDEPLOY_PYTORCH_MODEL_PATH}.qwen3_moe.Qwen3MoeForCausalLM',
})
...
# dflash
MODULE_MAP.update({'DFlashForCausalLM': f'{LMDEPLOY_PYTORCH_MODEL_PATH}.dflash.DFlashForCausalLM'})
MODULE_MAP.update({'DFlashDraftModel': f'{LMDEPLOY_PYTORCH_MODEL_PATH}.dflash.DFlashForCausalLM'})
