...
class Qwen3model(nn.Module):
    ...
    def __init__(self,
        ...
        # aux_hidden_state_layers for DFlash/EAGLE3
    ...
    def forward(
        ...
        # Collect auxiliary hidden states for DFlash/EAGLE3
        aux_hidden_states = []
...
class Qwen3ForCausalLM(nn.Module, CudaGraphMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        """Model forward, return hidden states."""
    ...
    def get_outputs_cudagraph(self, output_buffers: dict, input_ids: torch.Tensor, **kwargs):
