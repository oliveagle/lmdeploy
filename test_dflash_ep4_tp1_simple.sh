#!/bin/bash
# DFlash EP=4 + TP=1 测试 - 简化版

set -e

echo "========================================"
echo "DFlash EP=4 + TP=1 测试"
echo "========================================"
...
if __name__ == '__main__':
    ...
    print(f"EP=4, TP=1, session_len=128")
    print()

    # 不使用 DFlash speculative decoding
    # 先测试纯 EP 模式
    spec_config = None
...
python3 /tmp/test_ep4_tp1.py "$MODEL_PATH" "${DRAFT_MODEL:-}"
