...
def main():
    ...
    print(f"  TP: 4")
    print(f"  KV Cache: TurboQuant (42)")
    ...
    # 使用 TP=4，TurboQuant KV cache，小 KV cache
    engine_config = PytorchEngineConfig(
        tp=4,
        session_len=512,  # 更小的上下文
        cache_max_entry_count=0.2,  # 更小的 KV cache
        max_batch_size=1,
        block_size=16,
        eager_mode=True,
